...
test("Both POST /api/string/manual/repeat and POST /api/string/builtin/repeat responses are ok", async ({
  request,
}) => {
  const req1 = await request.post(`/api/string/manual/repeat`, {
    data: { str: reqStrRepeat, count: reqCount },
  });
  const req2 = await request.post(`/api/string/builtin/repeat`, {
    data: { str: reqStrRepeat, count: reqCount },
  });
...
test("Both POST /api/string/manual/repeat and POST /api/string/builtin/repeat messages are strings", async ({
  request,
}) => {
  const req1 = await request.post(`/api/string/manual/repeat`, {
    data: { str: reqStrRepeat, count: reqCount },
...
test("Both POST /api/string/builtin/repeat and POST /api/string/manual/repeat can handle valid inputs", async ({
  request,
}) => {
  const req1 = await request.post(`/api/string/builtin/repeat`, {
    data: { str: reqStrRepeat, count: reqCount },
  });
  const req2 = await request.post(`/api/string/manual/repeat`, {
    data: { str: reqStrRepeat, count: reqCount },
  });
  const req3 = await request.post(`/api/string/manual/repeat`, {
    data: { str: reqStrRepeat, count: stringCount },
  });
  const req4 = await request.post(`/api/string/builtin/repeat`, {
    data: { str: reqStrRepeat, count: stringCount },
  });
  const resBody1 = await req1.json();
  const resBody2 = await req2.json();
...
test("Both POST /api/string/manual/repeat and POST /api/string/builtin/repeat can handle empty string and zero count", async ({
  request,
}) => {
  const req1 = await request.post(`/api/string/manual/repeat`, {
    data: { str: emptyStr, count: reqCount },
  });
  const req2 = await request.post(`/api/string/builtin/repeat`, {
    data: { str: emptyStr, count: reqCount },
  });
  const req3 = await request.post(`/api/string/manual/repeat`, {
    data: { str: reqStrRepeat, count: zeroCount },
  });
  const req4 = await request.post(`/api/string/builtin/repeat`, {
    data: { str: reqStrRepeat, count: zeroCount },
  });
...
test("Both POST /api/string/manual/repeat and POST /api/string/builtin/repeat don't accept invalid arguments", async ({
  request,
}) => {
  const req1 = await request.post(`/api/string/manual/repeat`, {
    data: { str: numberStr, count: stringCount },
  });
  const req2 = await request.post(`/api/string/builtin/repeat`, {
    data: { str: numberStr, count: stringCount },
  });
  const req3 = await request.post(`/api/string/manual/repeat`, {
    data: { str: reqStrRepeat, count: negativeCount },
  });
  const req4 = await request.post(`/api/string/builtin/repeat`, {
    data: { str: reqStrRepeat, count: negativeCount },
  });
