...
test("Both GET /api/string/manual/padStart and GET /api/string/builtin/padStart responses are ok", async ({
  request,
}) => {
  const req1 = await request.post(`/api/string/manual/padStart`, {
    data: { str: emptyStr, length: equalToStrPlusOneFillLength, fill: shortFill },
  });
  const req2 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: emptyStr, length: equalToStrPlusOneFillLength, fill: shortFill },
  });
...
test("Both GET /api/string/manual/padStart and GET /api/string/builtin/padStart messages are strings", async ({
  request,
}) => {
  const req1 = await request.post(`/api/string/manual/padStart`, {
    data: { str: str1, length: equalToStrPlusOneFillLength, fill: longFill },
  });
  const req2 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: str1, length: equalToStrPlusOneFillLength, fill: longFill },
  });
...
test("Both GET /api/string/builtin/padStart and GET /api/string/manual/padStart can return valid str without changes", async ({
  request,
}) => {
  // {str: "abcde", length: 1, fill: "x", expectedResult: "abcde"}
  const req1 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: str2, length: shorterThanStrLength, fill: shortFill },
  });
  const req2 = await request.post(`/api/string/manual/padStart`, {
    data: { str: str2, length: shorterThanStrLength, fill: shortFill },
  });
  const resBody1 = await req1.json();
  const resBody2 = await req2.json();
  ...
  const req3 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: str1, length: equalToStrLength, fill: shortFill },
  });
  const req4 = await request.post(`/api/string/manual/padStart`, {
    data: { str: str1, length: equalToStrLength, fill: shortFill },
  });
  ...
  const req5 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: str1, length: equalToStrPlusOneFillLength, fill: emptyStr },
  });
  const req6 = await request.post(`/api/string/manual/padStart`, {
    data: { str: str1, length: equalToStrPlusOneFillLength, fill: emptyStr },
  });
  ...
  const req7 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: str1, length: nullStr, fill: shortFill },
  });
  const req8 = await request.post(`/api/string/manual/padStart`, {
    data: { str: str1, length: nullStr, fill: shortFill },
  });
  ...
  const req9 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: emptyStr, length: false, fill: shortFill },
  });
  const req10 = await request.post(`/api/string/manual/padStart`, {
    data: { str: emptyStr, length: false, fill: shortFill },
  });
  ...
  const req11 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: str1, length: emptyStr, fill: shortFill },
  });
  const req12 = await request.post(`/api/string/manual/padStart`, {
    data: { str: str1, length: emptyStr, fill: shortFill },
  });
...
test("Both GET /api/string/builtin/padStart and GET /api/string/manual/padStart are filling with space strings if no fill string is provided", async ({
  request,
}) => {
  // {str: "abc", length: 5, expectedResult: "  abc"}
  const req1 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: str1, length: shorterThanStrPlusOneFillLength },
  });
  const req2 = await request.post(`/api/string/manual/padStart`, {
    data: { str: str1, length: shorterThanStrPlusOneFillLength },
  });
...
test("Both GET /api/string/builtin/padStart and GET /api/string/manual/padStart are combining str and fill strings correctly", async ({
  request,
}) => {
  // {str: "abc", length: 4, fill: "x", expectedResult: "xabc"}
  const req1 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: str1, length: equalToStrPlusOneFillLength, fill: shortFill },
  });
  const req2 = await request.post(`/api/string/manual/padStart`, {
    data: { str: str1, length: equalToStrPlusOneFillLength, fill: shortFill },
  });
  ...
  const req5 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: emptyStr, length: shorterThanStrLength, fill: longFill },
  });
  const req6 = await request.post(`/api/string/manual/padStart`, {
    data: { str: emptyStr, length: shorterThanStrLength, fill: longFill },
  });
  ...
  const req7 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: str1, length: longerThanStrPlusOneFillLength, fill: shortFill },
  });
  const req8 = await request.post(`/api/string/manual/padStart`, {
    data: { str: str1, length: longerThanStrPlusOneFillLength, fill: shortFill },
  });
  ...
  const req9 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: str1, length: longerThanStrPlusOneFillLength, fill: longFill },
  });
  const req10 = await request.post(`/api/string/manual/padStart`, {
    data: { str: str1, length: longerThanStrPlusOneFillLength, fill: longFill },
  });
  ...
  const req11 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: emptyStr, length: equalToStrPlusOneFillLength, fill: longFill },
  });
  const req12 = await request.post(`/api/string/manual/padStart`, {
    data: { str: emptyStr, length: equalToStrPlusOneFillLength, fill: longFill },
  });
  ...
  const req13 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: str2, length: longerThanStrPlusOneFillLength, fill: numberStr },
  });
  const req14 = await request.post(`/api/string/manual/padStart`, {
    data: { str: str2, length: longerThanStrPlusOneFillLength, fill: numberStr },
  });
  ...
  const req15 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: str1, length: shorterThanStrPlusOneFillLength, fill: nullStr },
  });
  const req16 = await request.post(`/api/string/manual/padStart`, {
    data: { str: str1, length: shorterThanStrPlusOneFillLength, fill: nullStr },
  });
...
test("Both GET /api/string/manual/padStart and GET /api/string/builtin/padStart can handle invalid input", async ({
  request,
}) => {
  // {str: "123", length: 3, fill: "x", expectedResult: "Str should be a string"}
  const req1 = await request.post(`/api/string/manual/padStart`, {
    data: { str: numberStr, length: equalToStrLength, fill: shortFill },
  });
  const req2 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: numberStr, length: equalToStrLength, fill: shortFill },
  });
  ...
  const req3 = await request.post(`/api/string/manual/padStart`, {
    data: { str: nullStr, length: equalToStrLength, fill: shortFill },
  });
  const req4 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: nullStr, length: equalToStrLength, fill: shortFill },
  });
  const resBody3 = await req3.json();
  const resBody4 = await req4.json();
  ...
  const req5 = await request.post(`/api/string/manual/padStart`, {
    data: { str: nanStr, length: equalToStrLength, fill: shortFill },
  });
  const req6 = await request.post(`/api/string/builtin/padStart`, {
    data: { str: nanStr, length: equalToStrLength, fill: shortFill },
  });
  const resBody5 = await req5.json();
  const resBody6 = await req6.json();
  ...
  const req7 = await request.post(`/api/string/manual/padStart`, {
    data: { length: equalToStrLength, fill: shortFill },
  });
  const req8 = await request.post(`/api/string/builtin/padStart`, {
    data: { length: equalToStrLength, fill: shortFill },
  });
  const resBody7 = await req7.json();
  const resBody8 = await req8.json();
