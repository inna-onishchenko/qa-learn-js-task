...
test("Both GET /api/string/manual/split and GET /api/string/builtin/split responses are ok", async ({
  request,
}) => {
  const req1 = await request.post(`/api/string/manual/split`, {
    data: { str: reqStr1, separator: reqSeparator1 },
  });
  const req2 = await request.post(`/api/string/builtin/split`, {
    data: { str: reqStr1, separator: reqSeparator1 },
  });
...
test("Both GET /api/string/manual/split and GET /api/string/builtin/split messages are arrays", async ({
  request,
}) => {
  const req1 = await request.post(`/api/string/manual/split`, {
    data: { str: reqStr1, separator: reqSeparator1 },
...
test("Both GET /api/string/builtin/split and GET /api/string/manual/split can handle single character separators", async ({
  request,
}) => {
  const req1 = await request.post(`/api/string/builtin/split`, {
    data: { str: reqStr1, separator: reqSeparator1 },
  });
  const req2 = await request.post(`/api/string/manual/split`, {
    data: { str: reqStr1, separator: reqSeparator1 },
  });
  const resBody1 = await req1.json();
  const resBody2 = await req2.json();
...
test("Both GET /api/string/builtin/split and GET /api/string/manual/split can handle space separators", async ({
  request,
}) => {
  const req1 = await request.post(`/api/string/builtin/split`, {
    data: { str: reqStr2, separator: spaceSeparator },
  });
  const req2 = await request.post(`/api/string/manual/split`, {
    data: { str: reqStr2, separator: spaceSeparator },
  });
...
test("Both GET /api/string/builtin/split and GET /api/string/manual/split can handle multiple character separators", async ({
  request,
}) => {
  const req1 = await request.post(`/api/string/builtin/split`, {
    data: { str: reqStr3, separator: longSeparator },
  });
  const req2 = await request.post(`/api/string/manual/split`, {
    data: { str: reqStr3, separator: longSeparator },
  });
...
test("Both GET /api/string/manual/split and GET /api/string/builtin/split can handle invalid input", async ({
  request,
}) => {
  ...
  const req3 = await request.post(`/api/string/manual/split`, {
    data: { separator: reqSeparator1 },
  });
  const req4 = await request.post(`/api/string/builtin/split`, {
    data: { separator: reqSeparator1 },
  });
  const req5 = await request.post(`/api/string/manual/split`, {
    data: { str: numberStr, separator: reqSeparator1 },
  });
  const req6 = await request.post(`/api/string/builtin/split`, {
    data: { str: reqStr1, separator: nanSeparator },
  });
  const resBody1 = await req1.json();
  const resBody2 = await req2.json();
